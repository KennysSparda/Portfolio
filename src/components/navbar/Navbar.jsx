...
const Navbar = () => {
  ...
  return (
    <header
      className={`navbar-body bg-transparent bg-opacity-30 hover:bg-opacity-20 backdrop-filter backdrop-blur-lg fixed w-full transition-transform transform z-50 ${
